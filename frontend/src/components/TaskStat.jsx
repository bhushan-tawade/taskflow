...
const TaskStat = ({ totalTasks, completedTasks, pendingTasks, overdueTasks }) => {
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6 mt-8">
            ...
            {/* Completed */}
            <div className='bg-[#469d5a] hover:border dark:border-0 rounded-2xl lg:hover:-translate-x-1 lg:hover:translate-y-1 transition-transform duration-300 ease-out'>
                <div className="relative bg-[#83FF9F] border dark:border-0 p-6 md:p-8 lg:p-10 rounded-2xl shadow text-center overflow-hidden lexend
                lg:hover:translate-x-2 lg:hover:-translate-y-2 transition-transform duration-300 ease-out">
            ...
            {/* Pending */}
            <div className='bg-[#338599] hover:border dark:border-0 rounded-2xl lg:hover:-translate-x-1 lg:hover:translate-y-1 transition-transform duration-300 ease-out'>
                <div className="relative bg-[#6CE0FF] border dark:border-0 p-6 md:p-8 lg:p-10 rounded-2xl shadow text-center overflow-hidden lexend
                lg:hover:translate-x-2 lg:hover:-translate-y-2 transition-transform duration-300 ease-out">
            ...
            {/* Overdue */}
            <div className='bg-[#a23a3a] hover:border dark:border-0 rounded-2xl lg:hover:-translate-x-1 lg:hover:translate-y-1 transition-transform duration-300 ease-out'>
                <div className="relative bg-[#FF6D6D] border dark:border-0 p-6 md:p-8 lg:p-10 rounded-2xl shadow text-center overflow-hidden lexend
                lg:hover:translate-x-2 lg:hover:-translate-y-2 transition-transform duration-300 ease-out">
